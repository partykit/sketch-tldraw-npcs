...
export default function Debug() {
  ...
  return (
    <div className="fixed w-60 top-14 left-2 z-10">
      <section className="bg-neutral-200 flex flex-col gap-2 justify-start items-start shadow-lg shadow-cyan-300/50 outline outline-1 outline-neutral-200 w-full text-sm text-neutral-500">
